...
var Tooltip = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      if (this.state.hasBeenShown) {
        var currentPositions = (0, _position["default"])(direction, forceDirection, this.tip, this.target, _objectSpread(_objectSpread({}, this.state), {}, {
          showTip: showTip
        }), {
        ...
        var tipStyles = _objectSpread(_objectSpread({}, currentPositions.tip), {}, {
          background: useDefaultStyles ? defaultBg : background,
        ...
        var arrowStyles = _objectSpread(_objectSpread(_objectSpread({}, currentPositions.arrow.positionStyles), arrowContent ? {} : currentPositions.arrow.borderStyles), {}, {
          position: 'absolute',
          width: '0px',
          height: '0px',
        ...
        tipPortal = /*#__PURE__*/_react["default"].createElement(_Portal["default"], null, /*#__PURE__*/_react["default"].createElement("div", _extends({}, portalProps, {
      ...
      return /*#__PURE__*/_react["default"].createElement(TagName, props, children, tipPortal);
    }
  }]);
